...
public class Validation {
    ...
    private void validateSpecialCurrent(NODE_NAMES nodeName, DigitalIdentityListType sdiList, Object parent) {
        ...
        for (final DigitalIdentityType digitalIdentity : sdiList.getDigitalId()) {
            ...
            try {
                ...
                try {
                    x500Principal = DSSUtils.getSubjectX500Principal(x509Certificate);
                } catch (Exception e) {
            ...
            if (lastX500Principal != null) {
                ...
                if (DSSUtils.isNotEmpty(x509SubjectName)) {
                    ...
                    try {
                        ...
                        equals = DSSUtils.equals(x500Principal, lastX500Principal);
                    } catch (Exception e) {
    ...
    private void validateSpecialHistory(NODE_NAMES nodeName, DigitalIdentityListType sdiList, Object parent) {
        ...
        for (final DigitalIdentityType digitalIdentity : sdiList.getDigitalId()) {
            ...
            if (DSSUtils.isNotEmpty(x509SubjectName)) {
                ...
                if (lastX500Principal != null) {
                    if (!DSSUtils.equals(x500Principal, lastX500Principal)) {
    ...
    private void checkRuleServiceDigitalIdentifier() {
        ...
        for (final TSPServiceType service : services) {
            ...
            try {
                ...
                final X509Certificate x509ServiceCertificate = getCertificate(service);
                ...
                final X500Principal serviceSubjectX500Principal = DSSUtils.getSubjectX500Principal(x509ServiceCertificate);
                final byte[] serviceSki = DSSUtils.getSki(x509ServiceCertificate);
                ...
                for (final ServiceHistoryInstanceType history : serviceHistoryInstance) {
                    ...
                    final X509Certificate x509HistoryCertificate = getCertificate(history);
                    if (x509HistoryCertificate != null) {
                        ...
                        final X500Principal historySubjectX500Principal = DSSUtils.getSubjectX500Principal(x509HistoryCertificate);
                        if (historySubjectX500Principal != null) {

                            if (!DSSUtils.equals(serviceSubjectX500Principal, historySubjectX500Principal)) {
                        ...
                        final X500Principal historyIssuerX500Principal = DSSUtils.getIssuerX500Principal(x509HistoryCertificate);
                        final X500Principal serviceIssuerX500Principal = DSSUtils.getIssuerX500Principal(x509ServiceCertificate);
                        final boolean serialNumberEqual = serviceSerialNumber.equals(historySerialNumber);
                        final boolean issuerNameEqual = DSSUtils.equals(serviceIssuerX500Principal, historyIssuerX500Principal);
                    ...
                    if (historySdn != null) {
                        ...
                        if (!historySdn.equals(serviceSubjectX500Principal)) {
                            ...
                            if (!DSSUtils.equals(serviceSubjectX500Principal, historySdn)) {
    ...
    private X509Certificate getCertificate(final ServiceHistoryInstanceType history) {
    ...
    private X509Certificate getCertificate(final TSPServiceType service) {
    ...
    private X509Certificate getCertificate(final DigitalIdentityListType serviceDigitalIdentityList, final Object service) {
        ...
        if (currentCertificateBytes != null) {
            try {
                ...
                final X509Certificate certificate = DSSUtils.loadCertificate(currentCertificateBytes);
                return certificate;
