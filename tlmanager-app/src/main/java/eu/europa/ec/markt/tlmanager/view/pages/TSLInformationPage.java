...
public class TSLInformationPage extends TreeDataPublisher {
	private static final Logger LOG = LoggerFactory.getLogger(TSLInformationPage.class);
	...
	private void initComponents() {
		...
		schemeTypeCommunityRule = new MultivalueButton(MultiMode.MULTILANG_COMBOBOX, null,
			  Util.addNoSelectionEntry(Configuration.getInstance().getTSL().getTslSchemeTypeCommunityRules()));
	...
	public void updateViewFromData(TSLDataNode dataNode) {
		...
		LOG.trace("Value changed {}", schemeInformation);
