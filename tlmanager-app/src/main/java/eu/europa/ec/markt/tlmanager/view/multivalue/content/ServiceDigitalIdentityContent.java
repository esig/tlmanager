...
public class ServiceDigitalIdentityContent extends MultiContent<ServiceDigitalIdentityMultivalueAdapter> {
    ...
    private static final org.slf4j.Logger LOG = org.slf4j.LoggerFactory.getLogger(ServiceDigitalIdentityContent.class);
    ...
    protected ServiceDigitalIdentityMultivalueAdapter retrieveComponentValue(boolean clearOnExit) {
        final ServiceDigitalIdentityMultivalueAdapter serviceDigitalIdentityMultivalueAdapter = panel.getServiceDigitalIdentityMultivalueAdapter();
        if (clearOnExit) {
            panel.clearModel();
        }
    ...
    protected void updateValue() {
        ...
        if (value != null) {
            ...
            panel.setServiceDigitalIdentityMultivalueAdapter(new ServiceDigitalIdentityMultivalueAdapter(new DigitalIdentityListType()));
        }
